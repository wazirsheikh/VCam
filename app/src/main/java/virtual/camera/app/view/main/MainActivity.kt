...
class MainActivity : LoadingActivity() {
    ...
    private fun initFab() {
        ...
        viewBinding.fabKill.setOnClickListener {
            AppUtil.killAllApps()
    ...
    fun showFloatButton(show: Boolean) {
        ...
        if (show) {
            viewBinding.fab.animate().translationY(0f).alpha(1f).setDuration(time)
                .start()
            viewBinding.fabKill.animate().translationY(0f).alpha(1f).setDuration(time)
                .start()
        } else {
            viewBinding.fab.animate().translationY(tranY).alpha(0f).setDuration(time)
                .start()
            viewBinding.fabKill.animate().translationY(tranY).alpha(0f).setDuration(time)
                .start()
        }
    }
